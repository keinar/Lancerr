    ...
    return (
        <div className='packages-tabs'>
            <div className='nav-container'>
                <button onClick={() => onTabClick("basic")} className={selectedTab === 'basic' ? 'active' : ''}>Basic</button>
                <button onClick={() => onTabClick("standard")} className={selectedTab === 'standard' ? 'active' : ''}>Standard</button>
                <button onClick={() => onTabClick("premium")} className={selectedTab === 'premium' ? 'active' : ''}>Premium</button>
